...
def run_scaled_dot_product_attention(
    ...
    """
    return misc.scaled_dot_product_attention(Q, K, V, mask)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    mh_attn = MultiHeadSelfAttention(d_model, num_heads, rope_config=RopeConfig(theta, max_seq_len))
    mh_attn.load_state_dict(
        {
            "q_proj.weight": q_proj_weight,
            "k_proj.weight": k_proj_weight,
    ...
    return mh_attn.forward(in_features, token_positions=token_positions)
...
def run_rmsnorm(
    ...
    rmsnorm.load_state_dict(dict(weight=weights))
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return misc.softmax(in_features, dim)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    return misc.gradient_clipping(parameters, max_l2_norm)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    from cs336_basics.tokenizer import run_train_bpe as run_train_bpe_implementation

    return run_train_bpe_implementation(input_path, vocab_size, special_tokens, **kwargs)
